...
def main():
  ...
  plistpath = scriptpath + "/resources/Pararaised-VST2-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pararaised-AU-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pararaised-VST3-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pararaised-macOS-Info.plist"
  ...
  plistpath = scriptpath + "/resources/Pararaised-AAX-Info.plist"
  ...
  plistpath = scriptpath + "/installer/Pararaised.pkgproj"
  ...
  for line in fileinput.input(scriptpath + "/installer/Pararaised.iss",inplace=1):
