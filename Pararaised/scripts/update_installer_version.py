...
# WIN INSTALLER
  ...
  for line in fileinput.input(projectpath + "/installer/" + config['BUNDLE_NAME'] + ".iss",inplace=1):
    ...
    if "OutputBaseFilename" in line:
      if demo:
        line="OutputBaseFilename=Pararaised Demo Installer\n"
      else:
        line="OutputBaseFilename=Pararaised Installer\n"
    ...
    if "WelcomeLabel1" in line:
     if demo:
       line="WelcomeLabel1=Welcome to the Pararaised Demo installer\n"
     else:
       line="WelcomeLabel1=Welcome to the Pararaised installer\n"
       
    if "SetupWindowTitle" in line:
     if demo:
       line="SetupWindowTitle=Pararaised Demo installer\n"
     else:
       line="SetupWindowTitle=Pararaised installer\n"
